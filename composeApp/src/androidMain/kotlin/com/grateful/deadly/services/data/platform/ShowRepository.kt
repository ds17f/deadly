...
actual class ShowRepository actual constructor(
    ...
    actual suspend fun getNextShowByDate(currentDate: String): Show? = withContext(Dispatchers.IO) {
    ...
    actual suspend fun getPreviousShowByDate(currentDate: String): Show? = withContext(Dispatchers.IO) {
