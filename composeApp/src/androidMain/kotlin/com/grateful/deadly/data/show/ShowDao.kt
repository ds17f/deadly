...
actual class ShowDao actual constructor(
    ...
    actual suspend fun getRecentShowEntities(limit: Int): List<Pair<com.grateful.deadly.database.Show, String?>> = withContext(Dispatchers.IO) {
    ...
    actual suspend fun getUserRecordingPreference(showId: String): String? = withContext(Dispatchers.IO) {
        database.userRecordingPreferencesQueries.getRecordingPreference(showId).executeAsOneOrNull()
    }

    actual suspend fun setUserRecordingPreference(showId: String, recordingId: String, timestamp: Long) = withContext(Dispatchers.IO) {
        database.userRecordingPreferencesQueries.setRecordingPreference(showId, recordingId, timestamp)
    }

    actual suspend fun clearUserRecordingPreference(showId: String) = withContext(Dispatchers.IO) {
