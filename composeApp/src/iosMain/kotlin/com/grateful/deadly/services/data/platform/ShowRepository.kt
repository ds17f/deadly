...
actual class ShowRepository actual constructor(
    ...
    actual suspend fun recordShowPlay(showId: String, playTimestamp: Long) = withContext(Dispatchers.Default) {
    ...
    actual suspend fun getRecentShows(limit: Int): List<Show> = withContext(Dispatchers.Default) {
    ...
    actual suspend fun isShowInRecent(showId: String): Boolean = withContext(Dispatchers.Default) {
    ...
    actual suspend fun getRecentShowsStats(): RecentShowsStats = withContext(Dispatchers.Default) {
